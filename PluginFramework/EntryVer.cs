...
namespace Elskom.Generic.Libs
{
    ...
    public class EntryVer
    {
        ...
        /// <param name="filetime">The input file time.</param>
        /// <param name="algorithm">The input file's compression algorithm.</param>
        public EntryVer(string name, int uncompressedsize, int compressedsize, int relativeoffset, int checksum, int filetime, int algorithm)
        {
            this.Version = 3;
            this.Name = name;
            this.UncompressedSize = uncompressedsize;
        ...
        /// <param name="filetime">The input file time.</param>
        /// <param name="algorithm">The input file's compression algorithm.</param>
        public EntryVer(byte[] entrydata, string name, int uncompressedsize, int compressedsize, int relativeoffset, int checksum, int filetime, int algorithm)
        {
            this.Version = 3;
            this.Entrydata = entrydata;
            this.Name = name;
        ...
        /// <param name="algorithm">The input file's compression algorithm.</param>
        /// <param name="mappedID">The input file's mapped id.</param>
        public EntryVer(string name, int uncompressedsize, int compressedsize, int relativeoffset, int checksum, int filetime, int algorithm, string mappedID)
        {
            this.Version = 4;
            this.Name = name;
            this.UncompressedSize = uncompressedsize;
        ...
        /// <param name="algorithm">The input file's compression algorithm.</param>
        /// <param name="mappedID">The input file's mapped id.</param>
        public EntryVer(byte[] entrydata, string name, int uncompressedsize, int compressedsize, int relativeoffset, int checksum, int filetime, int algorithm, string mappedID)
        {
            this.Version = 4;
            this.Entrydata = entrydata;
            this.Name = name;
